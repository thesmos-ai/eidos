...
This project adheres to the [Contributor Covenant, version 2.1][cc].
...
permanent ban from the project, in response to behavior that they consider
harmful. The full enforcement guidelines are described in the
[Contributor Covenant, version 2.1][cc].
