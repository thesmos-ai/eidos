...
require (
	...
	go.thesmos.sh/eidos/bridge/protogo v1.2.0
	go.thesmos.sh/eidos/cli v1.2.0
	go.thesmos.sh/eidos/frontend/golang v1.2.0
	go.thesmos.sh/eidos/frontend/protobuf v1.2.0
	go.thesmos.sh/eidos/plugins v1.2.0
	go.thesmos.sh/eidos/reference v1.2.0
)
