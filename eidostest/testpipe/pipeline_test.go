...
// buildPipelineWithOutputs builds a testpipe.Pipeline whose stub
...
// of testing handle.
func buildPipelineWithOutputs(tb testing.TB, writes map[emit.Target][]byte) *testpipe.Pipeline {
	tb.Helper()
	return testpipe.New(tb).
